...
public class ProductViewController: UIViewController {
  ...
  private lazy var dataSource: UITableViewDiffableDataSource<Int, ProductUiModel> = {
  ...
  private lazy var tableView: UITableView = UITableView(frame: view.bounds, style: .plain)
